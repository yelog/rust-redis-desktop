...
### Added
- add large database quality checks
- improve large database workflows

### Fixed
- keep context menus within viewport
- validate Sparkle release signatures

## [0.2.2] - 2026-08-19

### Changed
- migrate interface icons to Lucide

## [0.2.1] - 2026-08-10

### Fixed
- run auto checks in Dioxus runtime

## [0.2.0] - 2026-07-28

### Fixed
- preserve expanded folders on key tree refresh
...
### Fixed
- show descendant key totals

### Changed
- sync lockfile with 0.1.8 release

## [0.1.8] - 2026-06-11

### Fixed
- use Sparkle for macOS manual updates
...
### Fixed
- show download progress and open installers

## [0.1.5] - 2026-06-08

### Fixed
- disable startup motion before theme settles

## [0.1.4] - 2026-06-02

### Changed
- update Homebrew tap on release
- add agent instructions

## [0.1.3] - 2026-05-20

### Added
- render update notes as markdown
